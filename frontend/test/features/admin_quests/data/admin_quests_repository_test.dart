...
void main() {
  group('AdminQuestsRepository', () {
    test('fetchDefinitions decodes the list', () async {
      final repo = _repo(
        MockClient((req) async {
          ...
          return http.Response(jsonEncode(_definitionsPayload), 200);
        }),
      );
    ...
    test('createDefinition posts new shape and returns id', () async {
      final repo = _repo(
        MockClient((req) async {
          ...
          expect(req.body, contains('"diamondReward":1'));
    ...
    test(
      'updateDefinition issues PUT with description/threshold/rewards',
      () async {
        final repo = _repo(
          MockClient((req) async {
            ...
            expect(req.body, contains('"undoReward":0'));
            expect(req.body, contains('"resetReward":0'));
            expect(req.body, contains('"diamondReward":2'));
...
const List<Map<String, Object?>> _definitionsPayload = [
  {
