...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get authEntryTitle => 'Empieza a jugar';

  @override
  String get authEntryMessage =>
      'Usa Apple para conservar tu progreso entre instalaciones, o continúa como invitado.';
  ...
  String diamondBundleAmount(Object amount) {
    return '$amount diamantes';
  }

  @override
  String diamondsAddedSnack(Object amount) {
    return '+$amount diamantes añadidos.';
  }
  ...
  @override
  String get appleAccountActivated => 'Cuenta de Apple activada.';

  @override
  String get guestSessionActivated => 'Sesión de invitado activada.';

  @override
  String get returnToGuest => 'Volver a invitado';
  ...
  String get leaderboardAllTimeDesc =>
      'Puntuación total histórica entre todos los jugadores.';

  @override
  String get leaderboardDailyDesc => 'Puntuación total de hoy (UTC).';

  @override
  String get leaderboardWeeklyDesc =>
      'Puntuación total de esta semana (UTC, inicio el lunes).';
  ...
  String get adminGrantEnergyHelper =>
      'Se suma a la energía actual, sin superar el máximo.';
