...
/// <summary>
/// Energy-private copy of the Quests B7 audit decorator template
    ...
    where T : ICommand
{
    ...
    public async Task Handle(T command, CancellationToken cancellationToken)
    {
        ...
        EnergyAdminAuditing.EnqueueAudit(command, adminCommand, adminUserId, _clock, _outbox, _notificationsMapper);
    }
}
...
internal static class EnergyAdminAuditing
{
    public static void EnqueueAudit(
        ...
        IDomainNotificationsMapper notificationsMapper)
    {
        var notification = new EnergyAdminActionPerformedNotification(
            id: Guid.NewGuid(),
        ...
        var typeKey = notificationsMapper.GetName(typeof(EnergyAdminActionPerformedNotification))
            ?? throw new InvalidOperationException(
                "EnergyAdminActionPerformedNotification is not registered in DomainNotificationsMap. " +
                "Add the mapping in EnergyStartup.");
