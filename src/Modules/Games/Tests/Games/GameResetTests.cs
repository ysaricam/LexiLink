...
public class GameResetTests : GameTestsBase
{
    ...
    public void ResetToStart_AfterSomeSteps_ClearsHistoryAndReturnsToStart_RaisesResetUsedDomainEvent()
    {
        ...
        var game = BuildGame(puzzle, maxSteps: 5, resets: 1);
        game.Start();
    ...
    public void ResetToStart_WhenHistoryIsEmpty_BreaksGameHistoryMustNotBeEmptyRule()
    {
        ...
        var game = BuildGame(puzzle, resets: 1);
        game.Start();
    ...
    [Test]
    public void ResetToStart_WhenNoResetsRemaining_BreaksResetAllowanceMustHaveRemainingRule()
    {
        var start = NewLinkId();
        var n1 = NewLinkId();
        var target = NewLinkId();
        ...
        AssertBrokenRule<ResetAllowanceMustHaveRemainingRule>(game.ResetToStart);
    }
}
