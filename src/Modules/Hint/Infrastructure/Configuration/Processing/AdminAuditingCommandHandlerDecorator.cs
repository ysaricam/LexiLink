...
/// <summary>
/// Hint-private copy of the Quests B7 audit decorator template
    ...
    where T : ICommand
{
    ...
    public async Task Handle(T command, CancellationToken cancellationToken)
    {
        ...
        HintAdminAuditing.EnqueueAudit(command, adminCommand, adminUserId, _clock, _outbox, _notificationsMapper);
    }
}
...
internal static class HintAdminAuditing
{
    public static void EnqueueAudit(
        ...
        IDomainNotificationsMapper notificationsMapper)
    {
        var notification = new HintAdminActionPerformedNotification(
            id: Guid.NewGuid(),
        ...
        var typeKey = notificationsMapper.GetName(typeof(HintAdminActionPerformedNotification))
            ?? throw new InvalidOperationException(
                "HintAdminActionPerformedNotification is not registered in DomainNotificationsMap. " +
                "Add the mapping in HintStartup.");
