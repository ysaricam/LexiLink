...
using LexiLink.Modules.Diamond.Infrastructure;
...
public abstract class TestBase
{
    ...
    protected IDiamondModule DiamondModule { get; private set; } = null!;
    protected DiamondContext DbContext { get; private set; } = null!;
    ...
    public void OneTimeSetUp()
    {
        ...
        DiamondStartup.Initialize(services, _connectionString);
        ...
        DiamondStartup.InitializeCompositionRoot(containerBuilder, _connectionString);
    ...
    public async Task SetUp()
    {
        ...
        DiamondModule = Scope.Resolve<IDiamondModule>();
        DbContext = Scope.Resolve<DiamondContext>();
    ...
    private static async Task ClearDatabaseAsync()
    {
        ...
        await connection.ExecuteAsync("""
            ...
            DELETE FROM "diamond"."OutboxMessages";
            DELETE FROM "diamond"."PlayerDiamondInventories";
