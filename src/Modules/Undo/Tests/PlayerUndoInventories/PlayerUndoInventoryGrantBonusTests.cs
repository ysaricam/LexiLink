...
[TestFixture]
public class PlayerUndoInventoryGrantBonusTests : TestBase
{
    ...
    public void GrantBonus_FromZero_IncrementsAndRaisesEvent()
    {
        ...
        var evt = AssertPublishedDomainEvent<PlayerUndoGrantedDomainEvent>(inventory);
    ...
    {
        var inventory = PlayerUndoInventory.InitializeFor(SamplePlayerId, initialBalance: 100);
