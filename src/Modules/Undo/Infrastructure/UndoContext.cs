...
public class UndoContext : DbContext
{
    public DbSet<PlayerUndoInventory> PlayerUndoInventories { get; set; } = null!;

    public DbSet<OutboxMessage> OutboxMessages { get; set; } = null!;

    private readonly ILoggerFactory _loggerFactory;

    public UndoContext(DbContextOptions<UndoContext> options, ILoggerFactory loggerFactory)
        : base(options)
    {
    ...
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        ...
        var typedIdTypes = typeof(UndoContext).Assembly.GetReferencedAssemblies()
            .Select(System.Reflection.Assembly.Load)
            .Concat([typeof(UndoContext).Assembly])
