...
using LexiLink.Modules.Administration.Infrastructure.Outbox;
using MediatR;
...
public class AdministrationAutofacModule : Autofac.Module
{
    ...
    public AdministrationAutofacModule(string connectionString)
    {
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.RegisterType<AdministrationDomainEventsDispatcher>()
            .AsSelf()
            .InstancePerLifetimeScope()
            .FindConstructorsWith(allCtors);

        builder.RegisterType<AdministrationUnitOfWork>()
            .AsSelf()
            .InstancePerLifetimeScope()
            .FindConstructorsWith(allCtors);
        ...
        builder.RegisterAssemblyTypes(typeof(AdministrationAutofacModule).Assembly)
