...
public abstract class TestBase
{
    ...
    protected IResetModule ResetModule { get; private set; } = null!;
    protected ResetContext DbContext { get; private set; } = null!;
    ...
    public async Task SetUp()
    {
        ...
        ResetModule = Scope.Resolve<IResetModule>();
        DbContext = Scope.Resolve<ResetContext>();
