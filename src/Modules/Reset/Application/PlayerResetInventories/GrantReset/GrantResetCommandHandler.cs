...
internal class GrantResetCommandHandler : ICommandHandler<GrantResetCommand>
{
    private readonly IPlayerResetInventoryRepository _repository;
    private readonly IClock _clock;

    internal GrantResetCommandHandler(
    ...
    public async Task Handle(GrantResetCommand request, CancellationToken cancellationToken)
    {
